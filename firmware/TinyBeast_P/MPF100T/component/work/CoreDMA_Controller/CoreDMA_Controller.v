//////////////////////////////////////////////////////////////////////
// Created by SmartDesign Tue Dec  6 10:20:10 2022
...
create_and_configure_core -core_vlnv {Actel:DirectCore:COREAXI4DMACONTROLLER:2.1.102} -component_name {CoreDMA_Controller} -params {\
...
assign TSTRB_const_net_0 = 8'h00;
...
// Component instances
//--------------------------------------------------------------------
//--------CoreDMA_Controller_CoreDMA_Controller_0_COREAXI4DMACONTROLLER   -   Actel:DirectCore:COREAXI4DMACONTROLLER:2.1.102
...
CoreDMA_Controller_0(
        ...
        .TSTRB        ( TSTRB_const_net_0 ), // tied to 8'h00 from definition
